 ...
 * 2018-08-06T10:49:50.963+02:00
 * Generated source version: 3.1.3
 * 
 */
@WebServiceClient(name = "EjbcaWSService", 
                  wsdlLocation = "file:docs/ejbcaws.wsdl",
...
public class EjbcaWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:docs/ejbcaws.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EjbcaWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:docs/ejbcaws.wsdl");
        }
        WSDL_LOCATION = url;
    }
